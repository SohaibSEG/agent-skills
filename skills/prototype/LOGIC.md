...
Create the file outside the project repository unless the user explicitly approves a project path.
...
Once the prototype has answered its question, report the answer and the artifact path. Do not lift the logic into the project, create a branch, or commit anything unless the user explicitly requests that separate implementation step.
